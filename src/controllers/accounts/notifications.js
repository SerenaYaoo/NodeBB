...
const notificationsController = {
    get(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let nids; // assuming notification ids are in integer type
...
// const notificationsController: { [key: string]: any } = {};
// notificationsController.get = async (req: ExtendedRequest, res: Response, next: NextFunction): Promise<void> => {
...
//         return next();
//     }
//     let nids: number[]; // assuming notification ids are in integer type
//     if ('filter' in selectedFilter) {
